...
import com.github.metabs.authentication.JwtTokenUtil;
...
import com.github.metabs.service.JwtUserDetailsService;
...
public class AuthenticationController {
  ...
  public ResponseEntity<?> saveUser(@RequestParam("first_name") String firstName,
    ...
    Map<String, Object> responseMap = new HashMap<>();
    User user = User.createUserWithoutArgs();
    user.changeId(UUID.randomUUID());
    user.changeFirstName(new Name(firstName));
    user.changeLastName(new Name(lastName));
    user.changeUsername(new Username(userName));
    user.changePassword(new Password(new BCryptPasswordEncoder().encode(password)));
